...
#}#!/bin/sh
# Base16 Rosé Pine Dawn - Shell color setup script
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 575279 # forground
  printf $printf_template_custom Ph faf4ed # background
  printf $printf_template_custom Pi 575279 # bold color
  printf $printf_template_custom Pj f2e9de # selection color
  printf $printf_template_custom Pk 575279 # selected text color
  printf $printf_template_custom Pl 575279 # cursor
  printf $printf_template_custom Pm faf4ed # cursor text
else
