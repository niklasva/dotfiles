...
#}#!/bin/sh
# Base16 Rosé Pine Moon - Shell color setup script
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Ph 232136 # background
  printf $printf_template_custom Pi e0def4 # bold color
  printf $printf_template_custom Pj 393552 # selection color
  printf $printf_template_custom Pk e0def4 # selected text color
  printf $printf_template_custom Pl e0def4 # cursor
  printf $printf_template_custom Pm 232136 # cursor text
else
