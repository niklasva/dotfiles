...
#}#!/bin/sh
# Base16 shb cool - Shell color setup script
# shebang
...
color01="9E/94/A8" # Base 08 - Red
color02="A9/B5/8D" # Base 0B - Green
color03="af/af/00" # Base 0A - Yellow
color04="83/ad/ad" # Base 0D - Blue
color05="5A/92/BF" # Base 0E - Magenta
...
color16="49/A1/C9" # Base 09
color17="B3/9A/9A" # Base 0F
