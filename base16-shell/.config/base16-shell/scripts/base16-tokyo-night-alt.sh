...
#}#!/bin/sh
# Base16 Tokyonight - Shell color setup script
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg c0caf5 # forground
  printf $printf_template_custom Ph 24283b # background
  printf $printf_template_custom Pi c0caf5 # bold color
  printf $printf_template_custom Pj 292e42 # selection color
  printf $printf_template_custom Pk c0caf5 # selected text color
  printf $printf_template_custom Pl c0caf5 # cursor
