...
#+begin_src emacs-lisp
  ...
  ;(set-face-attribute 'tab-bar nil :box nil :background (face-attribute 'default :background))
  ;(set-face-attribute 'tab-bar-tab nil :box nil :background (face-attribute 'default :background))
  ;(set-face-attribute 'tab-bar-tab-inactive nil :box nil :background (face-attribute 'default :background))
...
#+begin_src emacs-lisp
  (set-face-attribute 'default nil        :font "Roboto Mono 13" :weight 'unspecified)
  ;(set-face-attribute 'fixed-pitch nil    :font "SF Mono 13" :weight 'unspecified :height 1.0)
