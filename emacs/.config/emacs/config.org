...
(use-package font-lock
  :init
  (when (or (eq custom-enabled-themes nil)
            (niva/theme-is-active "doom-tomorrow-day")
            (niva/theme-is-active "ef-arbutus")
            (niva/theme-is-active "ef-day")
            (niva/theme-is-active "modus-operandi")
            (niva/theme-is-active "bharadwaj")
            (niva/theme-is-active "xemacs")
            (niva/theme-is-active "modus-operandi-tinted"))
