...
(use-package font-lock
  :init
  (when (or (eq niva/theme 'default) (eq niva/theme 'modus-operandi))
    (set-face-foreground 'font-lock-type-face "gray40"))
  ...
  ;; (font-lock-keyword-face ((t (:foreground unspecified :italic t))))
