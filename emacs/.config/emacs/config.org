...
#+begin_src emacs-lisp
  ...
  (add-hook 'org-mode-hook (lambda ()
    (when (eq niva/theme 'nofrils-acme)
...
* Olivetti
#+begin_src emacs-lisp
  (use-package olivetti :straight t :config (setq olivetti-style 'fancy))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (set-face-attribute face nil :foreground (face-attribute 'default :foreground)))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (dolist (pair '(("sh"   . "src sh")
                  ...
                  ("yaml" . "src yaml")
                  ("json" . "src json")
                  ("jp"   . "src jupyter-python :session py")
                  ("cpp"  . "src cpp")))
