...
#+begin_src emacs-lisp
  (use-package dired-sidebar
    ...
    (setq dired-sidebar-face '(:family "Helvetica" :height 0.8))
    (setq dired-sidebar-display-alist '((side . left) (slot . 1)))
    )
  ...
  (use-package ibuffer-sidebar
    ...
    (setq ibuffer-sidebar-use-custom-font t
          ibuffer-sidebar-face '(:family "Helvetica" :height 0.8))
    (setq ibuffer-sidebar-display-alist '((side . left) (slot . -1) (window-height . 0.3)))
    (setq ibuffer-sidebar-refresh-timer 0.1))
