...
#+begin_src emacs-lisp
  ...
  ;;(use-package emacs-color-themes       :straight t)
  (use-package farmhouse-themes         :straight t)
  (use-package flatui-theme             :straight t)
  (use-package flucui-themes            :straight t)
  (use-package gandalf-theme            :straight t)
  (use-package github-modern-theme      :straight t)
...
#+begin_src emacs-lisp
  (setq projectile-other-file-alist '(("cpp" "h" "hpp" "tpp")
                                      ("tpp" "h" "hpp" "cpp")
                                      ("hpp" "h" "ipp" "cpp")
                                      ("cxx" "hxx" "txx")
                                      ("ixx" "cxx" "hxx")
...
*** Git gutter
  (use-package git-gutter
    ...
    ;;                                   (set-face-attribute 'git-gutter:added nil :height 0.9 :weight 'thin :foreground (face-attribute 'default :foreground))
    ;;                                   (set-face-attribute 'git-gutter:modified nil :height 0.9 :weight 'thin :foreground (face-attribute 'default :foreground))
    ;;                                   (set-face-attribute 'git-gutter:deleted nil :height 0.9 :weight 'thin :foreground (face-attribute 'default :foreground))))
...
#+begin_src emacs-lisp
  ...
  (if (string-match-p "modus" (prin1-to-string custom-enabled-themes))
      (niva/modus-gutter))
  ;; (set-face-foreground 'git-gutter-fr:added (face-attribute 'ansi-color-green :foreground))
  ;; (set-face-foreground 'git-gutter-fr:modified (face-attribute 'ansi-color-blue :foreground))
  ;; (set-face-foreground 'git-gutter-fr:deleted (face-attribute 'ansi-color-red :foreground))
