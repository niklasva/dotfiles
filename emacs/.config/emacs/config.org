...
#+begin_src emacs-lisp
  ...
  (doom-modeline-def-modeline 'my-simple-line
    ...
    '(objed-state misc-info persp-name battery grip irc mu4e gnus github debug repl lsp minor-modes input-method indent-info buffer-encoding major-mode process vcs debug))
...
#+begin_src emacs-lisp
  (defun set-fonts()
    (set-face-attribute 'default nil        :font "Iosevka 15" :weight 'light)
    (set-face-attribute 'fixed-pitch nil    :font "Iosevka 15" :weight 'light)
(set-face-attribute 'variable-pitch nil :font "Iosevka 15" :weight 'light))
    ...
    (let ((family (face-attribute 'default :family))
      ...
      (mapcar (lambda (face)
                (face-remap-add-relative
                 face :family family :weight weight :height height))
              (face-list))))
