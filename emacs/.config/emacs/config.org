...
(defun niva/update-theme-faces ()
  ...
  (ignore-errors
    ...
    (when (string-match-p "less" (prin1-to-string niva/theme))
      (set-face-attribute 'elfeed-search-unread-title-face nil :inherit 'default :foreground 'unspecified)
      (set-face-attribute 'elfeed-search-title-face nil :inherit 'shadow :foreground "darkgray")
      (set-face-attribute 'elfeed-search-feed-face nil :inherit 'shadow :foreground "darkgray")
      (set-face-attribute 'elfeed-search-tag-face nil :inherit 'shadow :foreground "darkgray")
      )
