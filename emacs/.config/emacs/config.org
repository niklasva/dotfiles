...
#+begin_src emacs-lisp
  ...
  (define-key evil-normal-state-map (kbd "C-p") (lambda () (interactive) (evil-backward-paragraph 2) (forward-line 1)))
  (define-key evil-normal-state-map (kbd "C-n") (lambda () (interactive) (evil-forward-paragraph) (forward-line 1)))
...
** hl-text-block-mode
#+begin_src emacs-lisp
  (use-package hl-text-block-mode
    :straight (:host github :repo "niklasva/hl-text-block-mode")
    :config
    (setq hl-text-block-highlight-entire-line t)
    (set-face-attribute 'hl-text-block-face nil :inherit 'hl-line :weight 'bold :extend t))
#+end_src
