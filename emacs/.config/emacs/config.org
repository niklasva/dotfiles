...
*** Load theme
#+begin_src emacs-lisp
  (setq niva/theme 'sitaramv-solaris)
...
#+begin_src emacs-lisp
  ...
  (add-hook 'flymake-mode-hook
            (lambda ()
              ...
              (defface niva-flymake-fringe-warning '((t :inherit 'magit-diff-removed)) nil :group nil)
...
#+begin_src emacs-lisp
  ...
  (add-hook 'org-mode-hook #'org-syntax-remove-angle-bracket-match)
#+end_src
