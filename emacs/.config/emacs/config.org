...
#+begin_src disabled
  ...
  (set-face-attribute 'speedbar-button-face nil
                      ;; :family "Helvetica"
                      :height 0.8
                      :foreground (face-attribute 'ansi-color-green :foreground))
  ...
  (set-face-attribute 'speedbar-file-face nil
  					;; :family "Helvetica"
                      :height 0.8
                      :foreground (face-attribute 'ansi-color-cyan :foreground))
  ...
  (set-face-attribute 'speedbar-selected-face nil
  					;; :family "Helvetica"
                      :height 0.8
                      :underline t :foreground (face-attribute 'ansi-color-red :foreground))
...
#+begin_src emacs-lisp
  ...
  ;;           (lambda (frame _w)
  ;;             (set-face-attribute 'default frame :height 0.9)))
#+end_src
  ...
  (if niva/elfeed-enabled
    ...
    (use-package elfeed-protocol
      ...
      (setq elfeed-use-curl t
            ...
            elfeed-feeds '((niva/elfeed-fever-url
