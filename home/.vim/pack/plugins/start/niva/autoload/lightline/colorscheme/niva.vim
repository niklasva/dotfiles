" =============================================================================
" Filename: autoload/lightline/colorscheme/niva.vim
" Author: Niklas Vågstedt 
" License: MIT License
" Last Change: 2020/02/01 10:42:48.
" =============================================================================
...
let g:lightline#colorscheme#niva#palette = lightline#colorscheme#flatten(s:p)
